...
export default function Day6Page() {
    useGSAP(() => {
        // GSAP ScrollTrigger - animazioni con scrub sincronizzate con lo scroll
        gsap.to('.box', {
            scrollTrigger: {
                ...
                markers: true, // mostra i marker per il debug (rimuovi in produzione)
